...
import { Network, Zap, Shield, ArrowRight, Clock, Bell } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Escaneie e analise pontes de dados e conexões API com BridgeScan. Coming soon."
        />
      </Helmet>
                ...
                <div className="text-center space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Estamos construindo uma ferramenta poderosa para descoberta e análise de APIs.
